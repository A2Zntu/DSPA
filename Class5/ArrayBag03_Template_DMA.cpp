...
class BagInterface {
	public:
		...
		virtual bool contains(const ItemType entries[], const int len) const = 0;
...
class ArrayBag : public BagInterface<ItemType> {
	...
	public:
		...
		bool contains(const ItemType entries[], const int len) const;
...
template<typename ItemType>
bool ArrayBag<ItemType>::contains(const ItemType entries[], const int len) const {
	for(int i = 0; i < len; i++) {
